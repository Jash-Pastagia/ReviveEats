...
<section id="main-content">
 ...
 ?>
       ...
       <tr>
        <td style="color:purple;">  <b> Enter Email:</b></td> 
        <td> <input type="email" name="addvemail" required style="background-color: lightcoral; color: white; border-radius: 5px;margin-bottom: 15px;"  ></td>
       </tr>
       <tr>
        <td style="color:purple;">  <b> Enter Username:</b></td> 
        <td> <input type="text" name="addvusername" required style="background-color: lightcoral; color: white; border-radius: 5px;margin-bottom: 15px;"  ></td>
       </tr>
       ...
       <tr>
        ...
        <br>
        <tr> 
            <td style="color:purple;"> <b>Enter Password: &nbsp;&nbsp;&nbsp;&nbsp;</b></td>
        ...
        <tr>
        <td style="color:purple;">  <b> Enter Branch:</b></td> 
        <td> <input type="text" name="addvbranch" required style="background-color: lightcoral; color: white; border-radius: 5px;margin-bottom: 15px;"  ></td>
       </tr>
        <tr><td></td></tr>
        <tr> 
            <td>  </td>
