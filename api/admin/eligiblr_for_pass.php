                ...
                <div class="table-agile-info">
                    <div class="panel panel-default">
                        <div class="panel-heading">
                            <b>ELIGIBLE FOR BUS PASS USER DETAIL</b>
                        ...
                        <div>
                            ...
                            $q1 = "select * from u_detail where eligible='1' AND u_create='0'";
                            ...
                            if (isset($_POST['submit'])); {
                                try {
                                    ...
                                    if ($getcategory == "Student") {
                                        $q1 = "select * from u_detail where u_category='Student' AND eligible='1'  AND u_create='0'";
                                    } elseif ($getcategory == "Handicap") {
                                        $q1 = "select * from u_detail where u_category='Handicap' AND eligible='1'  AND u_create='0'";
                                    } elseif ($getcategory == "Citizen") {
                                        $q1 = "select * from u_detail where u_category='Citizen' AND eligible='1'  AND u_create='0'";
                                    } elseif ($getcategory == "Senior Citizen") {
                                        $q1 = "select * from u_detail where u_category='Senior Citizen' AND eligible='1'  AND u_create='0'";
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <!-- <form action="pass.php" method="get">
                                                        ...
                                                        <a href="pass.php?ids=<?php echo $row['u_id'];?>&fname=<?php echo $row['u_firstname'];?>&lname=<?php echo $row['u_lastname'];?>&category=<?php echo $row['u_category'];?>    ">CREATE</a>
                                                </td>
