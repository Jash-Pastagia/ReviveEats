    ...
    $q1 = "select * from u_detail";
            ...
            if(isset($_POST['submit']));
            {
                ...
                elseif($getcategory=="Handicap"){
                    $q1 = "select * from u_detail where u_category='Handicap'";

                }elseif($getcategory=="Citizen"){
                    $q1 = "select * from u_detail where u_category='Citizen'";

                }elseif($getcategory=="Senior Citizen"){
                    $q1 = "select * from u_detail where u_category='Senior Citizen'";
