                    ...
                    <ul class="sidebar-menu" id="nav-accordion">
                        ...
                        <li class="sub-menu">
                            ...
                            <ul class="sub">
                                ...
                                <li><a href="document_Verify_Pandding_User.php">Document Verify Pending User</a></li>
                ...
                <div class="table-agile-info">
                    <div class="panel panel-default">
                        ...
                        <div>
                            ...
                            $q1 = "select * from u_detail where u_doc_status='0' AND u_doc_success='1'";
                            ...
                            if (isset($_POST['submit'])); {
                                try {
                                    ...
                                    if ($getcategory == "Student") {
                                        $q1 = "select * from u_detail where u_category='Student' AND u_doc_status='0' AND u_doc_success='1'";
                                    } elseif ($getcategory == "Handicap") {
                                        $q1 = "select * from u_detail where u_category='Handicap' AND u_doc_status='0' AND u_doc_success='1'";
                                    } elseif ($getcategory == "Citizen") {
                                        $q1 = "select * from u_detail where u_category='Citizen' AND u_doc_status='0' AND u_doc_success='1'";
                                    } elseif ($getcategory == "Senior Citizen") {
                                        $q1 = "select * from u_detail where u_category='Senior Citizen' AND u_doc_status='0' AND u_doc_success='1'";
                                    ...
                                    <thead>
                                        ...
                                        ?>
                                            <tr>
                                                ...
                                                <td><a onclick="return confirm('Document are Confim ?');" href="doc_statusyes.php?ids=<?php echo $row['u_id']; ?>">Yes</a>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<a onclick="return confirm('Document are not clear ?');" href="doc_statusno.php?ids=<?php echo $row['u_id'];?>&fname=<?php echo $row['u_firstname'];?>&lname=<?php echo $row['u_lastname'];?>&category=<?php echo $row['u_category']; ?>">No</a></td>
                                                <!-- <td><input type="Button" name="yes" value="Yes"><br><br> <input type="button"  name="no" value="NO"></td> -->
                                                <td><form action="remark.php?ids=<?php echo $row['u_id'];?>"method="POST">
