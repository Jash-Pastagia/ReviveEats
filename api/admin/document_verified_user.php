...
<section id="main-content">
 ...
 <div class="panel panel-default">
    ...
    $q1 = "select * from u_detail where u_doc_status='1'";
            ...
            if(isset($_POST['submit']));
            {
                ...
                {
                    $q1 = "select * from u_detail where u_category='Student' AND u_doc_status='1'";
                }
                elseif($getcategory=="Handicap"){
                    $q1 = "select * from u_detail where u_category='Handicap' AND u_doc_status='1'";

                }elseif($getcategory=="Citizen"){
                    $q1 = "select * from u_detail where u_category='Citizen' AND u_doc_status='1'";

                }elseif($getcategory=="Senior Citizen"){
                    $q1 = "select * from u_detail where u_category='Senior Citizen' AND u_doc_status='1'";
        ...
        {?>
         <br><br>
            <p style="color: red; align-items: center;"><h2>There is no Data !!!!</h2></p>
        <?php }
        else
        {
      ...
      <table class="table"  ui-jq="footable" ui-options='{
        ...
        <tr>
         ...
         <tr>
                ...
                <td><a onclick="return confirm('Document are Confim ?');"href = "doc_statusyes.php?ids=<?php echo $row['u_id']; ?>">Yes</a>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<a onclick="return confirm('Document are not clear ?');"  href = "doc_statusno.php?ids=<?php echo $row['u_id']; ?>">No</a></td>
